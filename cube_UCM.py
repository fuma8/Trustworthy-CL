...
data_dir = '/home/kimishima/pytorch-classification-uncertainty/data/UCMerced_LandUse'
...
def train(epoch, M, PhiR, PhiG, PhiB):
    ...
    for batch_idx, (inputs, targets) in enumerate(train_loader):
        ...
        # plt.savefig("/home/kimishima/pytorch-classification-uncertainty/images/UCM_original.jpg")
        for i in range(M):
            cnt += 1
            ...
            # plt.subplot(131)
            # plt.imshow(image)
            # plt.savefig("/home/kimishima/pytorch-classification-uncertainty/images/UCM_cube_"+str(i)+".jpg")
            # exit()
...
def test(epoch, M, PhiR, PhiG, PhiB, flag):
    ...
    if flag == True and acc > best_acc:
        ...
        if not os.path.isdir('checkpoint'):
            os.mkdir('checkpoint')
        pth_path = './checkpoint/UCM_blk_size_'+str(blk_size)+'_learnable_matrix_proposed_loss.pth'
        dict_path = './checkpoint/UCM_blk_size_'+str(blk_size)+'_learnable_matrix_proposed_loss_dict.pth'
...
torch.save(acc_dic, "/home/kimishima/pytorch-classification-uncertainty/learnable_matrix_UCM_acc_blk_"+str(blk_size)+".pkl")
uncertainty_dic = {}
uncertainty_dic["train"] = train_uncertainty_list
uncertainty_dic["test"] = test_uncertainty_list
torch.save(uncertainty_dic, "/home/kimishima/pytorch-classification-uncertainty/learnable_matrix_UCM_uncertainty_blk_"+str(blk_size)+".pkl")
auc_dic = {}
auc_dic["train"] = train_auc_list
auc_dic["test"] = test_auc_list
torch.save(auc_dic, "/home/kimishima/pytorch-classification-uncertainty/learnable_matrix_UCM_auc_blk_"+str(blk_size)+".pkl")
...
# 画像の保存と表示
plt.tight_layout()
plt.savefig("/home/kimishima/pytorch-classification-uncertainty/images/learnable_matrix_UCM_acc_uncertainty_proposed_loss_blk_"+str(blk_size)+".jpg")
plt.show()
...
cs_result_file = open("/home/kimishima/pytorch-classification-uncertainty/learnable_matrix_UCM_result_blk_"+str(blk_size)+".txt", "w")
